<template>
  <div class="language_select">
    ...
    <button @click="toggleLanguageDropdown" :title="$t('choose_language')">
      <img src="../assets/icons/flags/globe.png" alt="az-flag"/>
    </button>

    <!-- Список языков -->
    <ul v-if="showLanguageDropdown" class="language-dropdown">
